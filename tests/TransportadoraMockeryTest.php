...
class TransportadoraMockeryTest extends TestCase {
	...
	public function testGetClientes() {
		...
		$clientes = $this->setUpMockery();
		$clientes->shouldReceive('all')->once()->andReturn(['Joao das Neves', 'Jose das Couves', 'Manolo Cabrero']);
	...
	public function testGetClientsPage() {
		...
		$this->assertViewHas('clientes', $clientes->all());
	}
}
